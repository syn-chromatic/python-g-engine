...
class ShapeProjector(ShapeProjectorBase):
    ...
    def update(self) -> Self:
        ...
        self.draw_shape(self.position.x, self.position.y)
        return self
    ...
    def apply_angular_force(self, force: Vector):
        xf, yf = force.get_tuple()
